...
@section('content')
  <div class="admin-form-main-block mrg-t-40">
     <h4 class="admin-form-text">
      @can('banneradd.view')
        <a href="{{url('admin/banneradd')}}" data-toggle="tooltip" data-original-title="{{__('GoBack')}}" class="btn-floating" title="{{ __('Reply') }}"><i class="material-icons">reply</i></a> 
      @endcan
      ...
      <div class="col-md-10">
        ...
        <div class="col-md-10">
          ...
          <div class="btn-group pull-right">
              <button type="submit" class="btn btn-success" title="{{ __('Update') }}">{{__('Update')}}</button>
          </div>
