...
@section('content')
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text">
      @can('blog.view')
        <a href="{{url('admin/banneradd')}}" data-toggle="tooltip" data-original-title="{{__('Go Back')}}" class="btn-floating" title="{{ __('Reply') }}"><i class="material-icons">reply</i></a> 
      @endcan
      {{__('Create Add')}}</h4>
    <div class="row">
      <div class="col-md-10">
        <div class="admin-form-block z-depth-1">
          ...
          <div class="form-group{{ $errors->has('column') ? ' has-error' : '' }} switch-main-block">
            ...
            <div class="btn-group pull-right">
              <button type="reset" class="btn btn-info" title="{{ __('Reset') }}"><i class="material-icons left">toys</i> {{__('Reset')}}</button>
              <button type="submit" class="btn btn-success" title="{{ __('Create') }}"><i class="material-icons left">add_to_photos</i> {{__('Create')}}</button>
            </div>
