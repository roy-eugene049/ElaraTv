      ...
      <div class="card-header movie-create-heading">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-4">
            <h5 class="card-title">{{ __('All Actors') }}
          ...
          <div class="col-lg-8 col-md-8 col-8">            
            ...
            data-target=".bd-example-modal-lg" title="{{ __('Import Actors') }}"><i class="fa fa-file-excel-o mr-2"></i> {{ __('Import Actors') }} </button>
            @can('actor.create')
            <a href="{{route('actors.create')}}" class="float-right btn btn-primary-rgba mr-2 mb-2" title="{{ __('Add Actor') }}"><i
                      ...
                      <div class="modal-header">
                          ...
                          <div class="col-md-12">
                              <div class="card-header">
                                  <a href="{{ url('files/Actors.xlsx') }}" class="float-right btn btn-success-rgba mr-2" title="{{ __('Download Example xls/csv File') }}"><i
                    ...
                    <div class="row">
                      ...
                      @foreach($actors as $item)
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="card">
                              @if($src != NULL)
                                 <a href="{{url('video/detail/actor_search', $item->slug)}}" target="__blank"  title="{{$item->name}}"><img src="{{$src}}" class="card-img-top" alt="{{$item->name}}"></a>
                              @endif
                                ...
                                <div class="dropdown card-dropdown">
                                    ...
                                    <div class="dropdown-menu pull-right" aria-labelledby="dropdownMenuButton-{{$item->id}}">
                                      @can('actor.view')
                                        <a class="dropdown-item" href="{{url('video/detail/actor_search', $item->slug)}}" target="__blank" title="{{ __('View') }}"><i class="feather icon-monitor mr-2"></i> {{__('View')}}</a> 
                                      @endcan
                                      @can('actor.edit')                                       
                                        <a class="dropdown-item" href="{{ route('actors.edit', $item->id)}}" title="{{ __('Edit') }}"><i class="feather icon-edit mr-2"></i> {{__('Edit')}}</a>
                                      @endcan
                                      @can('actor.delete')                                      
                                ...
                                <div class="card-header">
                                 <h5 class="card-title"><a href="{{url('video/detail/actor_search', $item->slug)}}" target="__blank" title="{{$item->name}}">{{$item->name}}</a></h5><br>
                                </div>
                                <div class="card-body ">
