...
@section('breadcum')
    ...
    <h4 class="page-title">{{ __('Create Director') }}</h4>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4">
                <div class="form-group text-dark{{ $errors->has('place_of_birth') ? ' has-error' : '' }}">
                  ...
                  {!! Form::text('place_of_birth', old('place_of_birth'), ['class' => 'form-control','row'=>'1', 'placeholder' => __('Please enter place of birth')]) !!}
              ...
              <div class="col-lg-12 col-md-4">
                 <div class="form-group text-dark{{ $errors->has('biography') ? ' has-error' : '' }}">
                  {!! Form::label('biography', __('Director Biography')) !!}<sup class="text-danger">*</sup>
