...
<br/>
	<div class="container">
           ...
           <div class="card-header">
          	...
          	<div class="card-body">
          		<div class="card-body" id="stepbox">
               			<strong class="text-black">{{ __('You tried to update the domain which is invalid !') }} {{-- <a target="_blank" href="https://codecanyon.net/item/next-hour-movie-tv-show-video-subscription-portal-cms-web-and-mobile-app/24626244/support">{{ __('Support') }}</a> {{ __('for updation in domain.') }}</strong> --}}
               			<hr>
                    ...
                    <form class="needs-validation" action="{{ url('/change-domain') }}" method="POST" novalidate>
                      ...
                      <div class="form-group">
                        ...
                        <input required class="form-control @error('domain') is-invalid @enderror" type="text" name="domain" value="{{ old('domain') }}" placeholder="eg:yourdomain.com"/>
                        ...
                        <small class="text-muted">
                          <i class="fa fa-question-circle"></i> {{__('IF still facing the access denied error please con')}} <a target="_blank" href="https://codecanyon.net/item/next-hour-movie-tv-show-video-subscription-portal-cms-web-and-mobile-app/24626244/support">{{ __('Support') }}</a> {{ __('for updation in domain.') }}.
                        </small>
        ...
        <p class="text-center m-3 text-white">&copy;{{ date('Y') }} | {{__('Next Hour - Movie Tv Show & Video Subscription Portal Cms Web And App')}}</a></p>
      </div>
