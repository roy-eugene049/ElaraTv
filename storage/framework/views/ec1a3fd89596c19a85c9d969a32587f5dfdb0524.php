...
<?php if($section->section_id == 1 && $recentlyadded != NULL && count($recentlyadded) >0): ?>
  <div class="genre-prime-block genre-prime-block-one genre-paddin-top genre-top-slider">
    <div class="container-fluid">
       ...
       <h5 class="section-heading"><?php echo e(__('Recently AddedIn')); ?> <?php echo e($menu->name); ?></h5>
          <?php if($auth && getSubscription()->getData()->subscribed == true): ?>
    ...
    <?php if($section->section_id == 3 && $featuresitems != NULL && count($featuresitems)>0): ?>
      <div class="genre-prime-block genre-prime-block-one genre-paddin-top">
         <div class="container-fluid">
              ...
              <h5 class="section-heading"><?php echo e(__('Featured In')); ?> <?php echo e($menu->name); ?></h5>
    ...
    <?php if($section->section_id == 12  && $top_data != NULL): ?>
      <div class="top-ten-main-block">
        <div class="container-fluid">
          ...
          <h5 class="section-heading"><?php echo e(__('Top rated')); ?> <?php echo e(__('in')); ?> <?php echo e($menu->name); ?></h5>
          ...
          <?php if($section->section_id == 5 && $historyadded != NULL && count($historyadded) >0): ?>
            <div class="genre-prime-block genre-prime-block-one genre-paddin-top">
               <div class="container-fluid">
                    ...
                    <h5 class="section-heading"><?php echo e(__('Continue Watching For')); ?> <?php echo e(Auth::user()->name); ?></h5>
                            ...
                            <div class="slider-height-dtl">
                              <img src="<?php echo e(url('images/logo/'.$logo)); ?>" class="img-responsive" alt="<?php echo e($w_title); ?>">
                                ...
                                <div class="row">
                                  ...
                                  <?php endif; ?>
                                  <br/>
                                  <p class="text-right promotion"># <?php echo e(count($homeblocks)); ?>  <?php echo e(__('top in')); ?> <?php echo e($menu->name); ?></p>
                            </div>
                          <?php elseif($item->type === 'T'): ?>
                            <div class="slider-height-dtl">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/elaratvc/elaratv.in/resources/views/home.blade.php ENDPATH**/ ?>