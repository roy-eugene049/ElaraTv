<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('package-feature.edit')): ?>
      <a class="dropdown-item" href="<?php echo e(route('package_feature.edit', $id)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
      <?php endif; ?>
  ...
  <div class="modal-dialog modal-sm">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <form method="post"
                  action="<?php echo e(route("package_feature.destroy", $id)); ?>"
                  class="pull-right">
...
<!-- delete Model ended --><?php /**PATH /home3/elaratvc/elaratv.in/resources/views/admin/package_feature/action.blade.php ENDPATH**/ ?>