              ...
              <tr  class="sortable row1" data-id="<?php echo e($package->id); ?>">
                ...
                <td>
                  <div class="admin-table-action-block">
                    ...
                    <a class="btn btn-round btn-outline-primary" data-original-title="<?php echo e(__('Restore Package')); ?>" ><i class="fa fa-pencil"></i></a>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/elaratvc/elaratv.in/resources/views/admin/package/index.blade.php ENDPATH**/ ?>